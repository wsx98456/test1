...
public class PurchaseOrderDAOImpl implements PurchaseOrderDAO{
	...
	public void create(Product aProduct, int qty) { //order product
	...
	public int stockProduct(long poid) throws SQLException { //import one product ,keep purchaseorder and update product    
		int result = 0;
